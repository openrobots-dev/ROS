...
setpoint_limits = rospy.get_param('setpoint_limits', {'x': 1, 'y': 1, 'w': 1})
...
def joy_cb(msg):
    ...
    setpoint['x'] = msg.axes[0] * gear_ratio[gear]['x']
    setpoint['y'] = msg.axes[1] * gear_ratio[gear]['y']
    setpoint['w'] = msg.axes[2] * gear_ratio[gear]['w']
...
def main():    
    ...
    pubVelocity = rospy.Publisher('/' + robot + '/velocity', Velocity)
